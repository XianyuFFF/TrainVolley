...
def get_ball_loc_data(video_dir, output_path, ball_moments, cam_id, min_ball_size=4, max_ball_size=30):
    bgs = BgsModel()
    ...
    output_json_dir = detected_ball_json_dir(video_dir, output_path, cam_id)
